...
/**
 * @description A function based on a validation lib.
 * @see https://github.com/validatorjs/validator.js/blob/master/src/lib/isISO8601.js
 * @author not me
 */
export default function isISO8601(str: string, options: IsISO8601Options = {}) {
